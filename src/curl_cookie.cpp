...
namespace curl {
    ...
    void curl_cookie::set_cookie_file(const std::string file = "") NOEXCEPT {
        this->easy.add<CURLOPT_COOKIEFILE>(file.c_str());
    }

    // Implementation of set_cookie_list method.
    void curl_cookie::set_cookie_list(const std::string list) NOEXCEPT {
    ...
    // Implementation of overloaded set_cookie_list method.
    void curl_cookie::set_cookie_list(const std::vector<std::string> &list) NOEXCEPT {
        std::string cookies;
    ...
    // Implementation of overloaded set_cookie_list method.
    void curl_cookie::set_cookie_list(const std::ostringstream list) NOEXCEPT {
